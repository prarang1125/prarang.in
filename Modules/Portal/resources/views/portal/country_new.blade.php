        ...
        <div class="flex items-center gap-6">
          ...
          <div class="flex flex-col gap-2">
            <div class="flex items-center bg-gray-100 p-1 rounded-full border">
              <button class="px-4 py-1 rounded-full text-xs font-bold bg-blue-600 text-white shadow-sm">EN</button>
    ...
    <div id="core">
      <div class="core__inner">
                  ...
                  <main id="main">
                    <div class="main__inner">
                      <div class="post-207 page type-page status-publish hentry">
                        <div class=" my-3 rounded shadow">
                          <img class="rounded shadow" src="{{ Storage::url($main->header_image) }}" alt="">
                        </div>
                        <div class="page__content rounded-lg shadow bg-light p-3 text-sm text-justify">
                          <p>
                        ...
                        @else
                        <x-portal.connection-box :main="$main" :primary="$primary" :secondary="$secondary"
                          :locale="$locale" />
                        @endif
                    ...
                    <div class="shadow mt-2 bg-light">
                      ...
                      <div class="comparison-links-new px-3 pb-2">
                        <a class="comparison-btn" target="_blank"
                          href="{{ url('/' . $primary->country_name .'/'. $secondary->country_name . "
                          /country-comparison/" . $secondary->anlytics_code . '/' . $primary->anlytics_code) }}">
                          <strong>Country Comparison :&nbsp;</strong> <span>Compare {{$secondary->country_name
                            }} and {{$primary->country_name }} with Other Countries</span>
                        </a>
                    ...
                    <section class="mt-3">
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div
                            class="widget lsvr-townpress-analytics-widget lsvr-townpress-analytics-widget--has-background shadow-sm mb-4 border rounded"
                            id="-analytics-widget">
              ...
              <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6 text-center">
                  ...
                  <div class="social-grid justify-content-center mt-3">
                    <a href="javascript:void(0)" onclick="showComingSoon(event)" class="social-btn" title="Facebook">
                      <i class="fa fa-facebook"></i>
                    </a>
                    <a href="https://www.linkedin.com/company/india-nepal/" href="javascript:void(0)"
                      onclick="showComingSoon(event)" class="social-btn" title="X (Twitter)">
        ...
        <script id="jquery-core-js"
          src="https://preview.lsvr.sk/townpress/wp-includes/js/jquery/jquery.min.js?ver=3.7.1" type="text/javascript">
        </script>
