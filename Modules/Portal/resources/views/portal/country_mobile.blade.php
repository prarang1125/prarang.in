                ...
                <div class="flex items-center gap-5">
                    ...
                    <div class="flex flex-col gap-2">
                        <div class="flex items-center bg-gray-100 p-1 rounded-full border">
                            ...
                            <button id="secondary-language" onclick="showComingSoonToast(' Coming Soon.')"
            ...
            <div class="px-4 py-3 grid grid-cols-2 gap-3">
                ...
                <x-ui.modal id="time-cze-modal">
                    ...
                    <x-slot name="button">
                        <div
                            ...
                            <div
                                class="absolute top-0 right-0 p-1 opacity-20 group-hover:opacity-40 transition-opacity">
                ...
                class="w-5 h-3 object-cover rounded-sm" alt="IN"> --}}
                  ...
                  alt="IN"> --}}
                            ...
                            <div class="text-xs font-bold text-orange-800 mb-1"> {{ $secondary->country_name }} Time
                            </div>
...
<section class="mb-4">
                    ...
                    <div class="px-4 py-3 border-b border-gray-100">
                        <div class="flex items-center gap-2 mb-1">
                            ...
                            <h2 class="text-base font-semibold text-gray-900"> {{ $primary->country_name }} -
                                {{ $secondary->country_name }} Connections</h2>
                    ...
                    <div class="px-4 py-4">
                        <x-ui.modal id="cn-tags-modal">
                            ...
                            <x-slot name="button">
                                <div class="grid grid-cols-2 gap-4 w-full">
                                    ...
                                    <div
                                        ...
                                        <span
                                            class="text-xl font-black text-slate-800 mb-4 tracking-tighter">Culture</span>
                                    ...
                                    <div
                                        ...
                                        <span
                                            class="text-xl font-black text-slate-800 mb-4 tracking-tighter">Nature</span>
                            ...
                            <div class="page__content">
                                ...
                                <x-portal.nep-tag-list :cityId="$main->content_country_code" :cityCode="$main->content_country_code" :citySlug="$main->slug"
                                    :locale="$locale" />
                            </div>
                        </x-ui.modal>
                    </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="px-4 py-3 border-b border-gray-100">
                    <h2 class="text-base font-semibold text-gray-900 text-center">
                        ...
                        {{ $secondary->country_name }} Comparative AI
                    </h2>
                </div>
              ...
              hover:shadow-2xl ">
                        <div
                            class="absolute inset-0 bg-blue-600/10 opacity-0 group-hover:opacity-100 transition-opacity">
                        </div>

                        <div class="text-sm font-black text-white drop-shadow-sm uppercase tracking-tight">
                            {{ $primary->country_name }} - {{ $secondary->country_name }} Comparison</div>
                    ...
                    <a href="https://www.prarang.in/ai/upmana" target="_blank"
                        ...
                        <div class="text-sm font-black text-white drop-shadow-sm uppercase tracking-tight">UPMANA AI
                        </div>
                ...
                {{-- AI Reports --}}
                <div class="px-4 pb-3">
                    <x-portal.ai-reports :primary="$primary" :secondary="$secondary" :cities="$indianCities" :zone="$stateZones" />
                </div>
            </div>
        </section>
    ...
    <style>
        ...
        </sty><footer class="portal-footer"><div class="container py-5"><div class="row g-4">{{-- About Section --}} <div class="col-lg-5 col-md-6 pe-lg-5"><h5 class="footer-title text-start">About Prarang</h5><p class="footer-text text-start text-white-50">Prarang provides integrated digital solutions and unique insights to understand the cities of India and the World. Through our composite methodology of traditional research from rare books,
        maps and images,
        a Big database of India and World Metrics,
        our own SLM Model based on Indian Linguistics,
        we provide in depth city - hyperlocal knowledge,
        comprehensive knowledge by comparison between cities of the world,
        through our content,
        analytics,
        and semiotics solutions,
        for governance & corporate communication,
        while being localisation ready for any language/script. </p></div>{{-- Social Connect --}} <div class="col-lg-3 col-md-6 text-center"><h5 class="footer-title">Connect With Us</h5><div class="social-grid justify-content-center mt-3"><a href="https://www.facebook.com/IndiaCzech/" target="_blank" class="social-btn" title="Facebook"><i class="fa fa-facebook"></i></a><a href="https://x.com/IndiaCzech" target="_blank" class="social-btn" title="X (Twitter)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" style="display: inline-block; vertical-align: middle;"><path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z" /></svg></a><a href="https://www.linkedin.com/company/india-czech" target="_blank" class="social-btn" title="LinkedIn"><i class="fa fa-linkedin"></i></a></div></div>{{-- Address Section --}} <div class="col-lg-4 col-md-12"><h5 class="footer-title text-start text-md-center text-lg-start">Contact Us</h5><ul class="list-unstyled footer-text text-white-50 text-start text-md-center text-lg-start"><li class="mb-2"><i class="fa fa-map-marker me-2 text-primary"></i>Office #25,
        11th Floor,
        The I-Thum,
        A40,
        Sector 62<br>Noida (U.P),
        India 201309 </li><li class="mb-2"><i class="fa fa-phone me-2 text-primary"></i>+91-1204561284 </li><li><i class="fa fa-envelope me-2 text-primary"></i><a href="mailto:ask_me@prarang.in" class="text-white-50 text-decoration-none hover-white">ask_me@prarang.in </a></li></ul></div></div></div>{{-- Bottom Copyright --}} <div class="footer-bottom"><div class="container text-center"><p class="mb-0 text-white-50 small">© 2017 - {{ date('Y') }} Indoeuropeans India Pvt. Ltd. | All rights reserved. </p><p class="mb-0 text-white-50 x-small mt-1 opacity-50">Content protected by international copyright laws. </p></div></div></footer><style>.portal-footer {
