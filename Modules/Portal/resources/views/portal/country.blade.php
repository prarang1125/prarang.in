        ...
        <header class="px-5 lsvr-container">
            <div class="flex lg:flex-row flex-col justify-between items-center gap-6 mx-auto max-w-[1920px]">
                ...
                <div class="flex items-center gap-6">
                    ...
                    <div class="flex flex-col gap-2">
                        <div class="flex items-center bg-gray-100 p-1 border rounded-full">
                            <button
                                class="bg-blue-600 shadow-sm px-4 py-1 rounded-full font-bold text-white text-xs">EN</button>
                            <button onclick="showComingSoonToast('Czech Language Content - Coming Soon.')"
                                class="hover:bg-gray-200 px-4 py-1 rounded-full font-bold text-gray-500 text-xs transition-colors">HI</button>
                        </div>
                        {{-- <a
                            class="group flex items-center gap-2 bg-red-600 hover:bg-red-700 shadow-md px-4 py-2 rounded-md text-white transition-all"
                            href="{{ url($main->slug) }}/all-posts">
                            <span class="font-bold text-sm">All Posts</span>
                        </a> --}}
                    </div>
                </div>
                ...
                {{-- <div class="flex flex-col gap-3 w-full lg:w-auto">
                    <!-- Stats Grid -->
                    <div class="bg-slate-900 shadow-inner p-3 border border-slate-700 rounded-lg text-white">
                        <div class="gap-2 grid grid-cols-1 text-[11px]">
                    ...
                    <div class="flex gap-2 w-full lg:w-auto" style="width: 286px">
                        <a target="_blank" href="https://b2b.prarang.in/login?lt=partner"
                            class="flex-1 bg-amber-400 hover:bg-amber-500 shadow hover:shadow-md rounded font-bold text-black text-xs text-center transition-all"
                                    ...
                                    <main id="main">
                                        ...
                                        <div class="bg-light shadow mt-2">
                                            ...
                                            <div class="px-3 pb-2 comparison-links-new">
                                                ...
                                                <a class="mt-2 comparison-btn" href="javascript:void(0)"
