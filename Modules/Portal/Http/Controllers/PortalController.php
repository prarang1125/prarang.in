...
class PortalController extends Controller
{
    ...
    public function bilateralCountriesPortal(string $slug)
    {
        ...
        // Fetch all bilateral connections for country connections section
        $countryConnections = BiletralPortal::with(['primaryCountry', 'secondaryCountry'])->get();

        return view('portal::portal.country', compact('main', 'primary', 'secondary', 'countryConnections'));
    }
}
