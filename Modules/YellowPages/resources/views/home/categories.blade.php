...
{{-- @section('meta_keywords', isset($category->name) ? $category->name . ', businesses, services' : $city->name . ',
businesses, services') --}}
...
Storage::url($city->cities_url) : asset('assets/images/default.jpg')))
<style>
    /* Italic Tag */
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                ...
                <img src="{{ Storage::url($listing->business_img ?? 'default.jpg') }}" class="card-img-top"
                    alt="Listing Image" style="height: 220px; object-fit: cover;">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-2">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <strong class="text-dark"><i class="bi bi-calendar-week"></i> {{ __('yp.next_open')
                                    }}</strong>
                    ...
                    <p class="card-text text-dark mt-0">
                        <span class="text-muted"><i class="bi bi-person-workspace fw-bold"></i> {{ __('yp.owner')
                            }}:</span>
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <a href="javascript:void(0)"
                                onclick="copyToClipboard(this,'{{ $listing->user->phone ?? 'N/A' }}')"
                                class="btn btn-success text-white fw-bold w-100 rounded-pill">
                                <span class="text-muted"><i class="bi bi-phone text-white"></i></span>
