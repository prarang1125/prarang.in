                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb text-light mb-2">
                            <li class="breadcrumb-item"><a href="/"
                                    class="text-light opacity-75 text-decoration-none">{{ __('yp.home') }}</a></li>
                            <li class="breadcrumb-item"><a href="#"
                                    class="text-light opacity-75 text-decoration-none">{{ __('yp.businesses') }}</a></li>
                    ...
                    <div class="mt-2 d-flex align-items-center flex-wrap gap-3">
                        ...
                        @if ($listing->category)
                            <span class="text-light opacity-75 small">
                                <i class="bx bx-category me-1"></i> {{ __('yp.' . $listing->category->name) }}
                            </span>
                        @endif
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                    ...
                    <div class="d-flex gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <a href="https://www.google.com/maps/search/?api=1&query={{ urlencode($listing->business_address) }}"
                                ...
                                <i class="bx bx-navigation"></i> {{ __('yp.get_directions') }}
                            </a>
                        </div>
                    </div>
                ...
                <div class="card card-custom p-4">
                    ...
                    <ul class="working-hours-list">
                        ...
                        @forelse($listingHours as $hour)
                            <li class="{{ strtolower($hour->day) == $today ? 'current-day' : '' }}">
                                ...
                                <span>
                                    @if ($hour->is_24_hours)
                                        <span
                                            class="badge bg-success opacity-75 small fw-normal">{{ __('yp.24_hours') }}</span>
                                    @else
                        ...
                        @empty
                            <li class="text-muted small italic">{{ __('yp.no_hours_provided') }}</li>
                        @endforelse
                    </ul>
                </div>
            </div>
            ...
            <div class="modal-content border-0 rounded-4 shadow-lg">
                ...
                <div class="modal-body p-4">
                    <form method="POST" action="{{ route('reviews.store', $listing->id) }}"
                        ...
                        @foreach (['cleanliness' => __('yp.cleanliness'), 'service' => __('yp.service'), 'ambience' => __('yp.ambience'), 'price' => __('yp.price')] as $key => $label)
                            <div class="mb-4">
                                <label
                                    class="form-label d-block fw-bold small text-uppercase text-muted mb-2 ls-1">{{ $label }}</label>
                        ...
                        <div class="mb-3">
                            <label
                                class="form-label fw-bold small text-uppercase text-muted">{{ __('yp.review_title') }}</label>
                        ...
                        <div class="mb-3">
                            <label
                                class="form-label fw-bold small text-uppercase text-muted">{{ __('yp.review') }}</label>
                        ...
                        <div class="mb-4">
                            <label
                                class="form-label fw-bold small text-uppercase text-muted">{{ __('yp.select_images') }}</label>
                            <input type="file" name="image[]" class="form-control border-light-subtle rounded-3"
                                multiple>
                        </div>
