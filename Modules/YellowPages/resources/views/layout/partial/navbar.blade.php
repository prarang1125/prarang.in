                ...
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                    ...
                    <div class="user-info ps-3">
                        @if (Auth::guard('admin')->check())
                            <p class="mb-0 user-name" id="{{ Auth::guard('admin')->user()->userId }}">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    @if (Auth::guard('admin')->check())
                        ...
                        <li><a class="dropdown-item"
                                href="{{ url('yellow-pages/admin/user-edit/' . Auth::guard('admin')->id()) }}"><i
                                    class="bx bx-user"></i><span>प्रोफ़ाइल</span></a>
                        </li>
                        <li><a class="dropdown-item" href="{{ route('admin.dashboard') }}"><i
                                    class='bx bx-home-circle'></i><span>डैशबोर्ड</span></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ route('admin.logout') }}"><i
                                    class='bx bx-log-out-circle'></i><span>लॉग आउट</span></a>
                            {{-- @elseif (Auth::check())
                    ...
                    @elseif (Auth::check())
                        ...
                        <li><a class="dropdown-item" href="javascript:;"><i
                                    class="bx bx-cog"></i><span>सेटिंग्स</span></a>
                        </li>
                        <li><a class="dropdown-item" href="javascript:;"><i
                                    class='bx bx-home-circle'></i><span>डैशबोर्ड</span></a>
                        </li>
                        <li><a class="dropdown-item" href="javascript:;"><i
                                    class='bx bx-dollar-circle'></i><span>आय</span></a>
                        </li>
                        <li><a class="dropdown-item" href="javascript:;"><i
                                    class='bx bx-download'></i><span>डाउनलोड</span></a>
                        </li>
                        <li>
                            <div class="mb-0 dropdown-divider"></div>
                        </li>
