...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="{{ asset('modules/yellowpages/assets/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
  <link href="{{ asset('modules/yellowpages/assets/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
  <link href="{{ asset('modules/yellowpages/assets/vendor/aos/aos.css') }}" rel="stylesheet">
  <link href="{{ asset('modules/yellowpages/assets/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
  
{{-- 
  <link href="modules/yellowpages/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="modules/yellowpages/assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet"> 
  <link href="modules/yellowpages/assets/vendor/aos/aos.css" rel="stylesheet">
  <link href="modules/yellowpages/assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet"> 
  <link href="modules/yellowpages/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet"> --}}
  

  <!-- Main CSS File -->

  <link href="modules/yellowpages/assets/css/main.css" rel="stylesheet">
</head>
        ...
        <div class="row gy-5 justify-content-center">
            <div class="col-lg-8 order-2 order-lg-1 d-flex flex-column justify-content-center mx-auto">
                ...
                <div class="text-center lp-search-description" style="margin-top: 20px;">
                    ...
                    <img src="storage/images/banner-arrow.png" alt="banner-arrow" class="banner-arrow" style="margin-top: 10px;" />
                </div>
            </div>
        </div>
    </div>
