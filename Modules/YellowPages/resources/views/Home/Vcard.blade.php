        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 text-center" style="margin-bottom: 30px;">
                <div style="background: linear-gradient(145deg, #81c784, #66bb6a); border-radius: 15px; padding: 30px; box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1); position: relative;">
                    ...
                    <a href="#" style="background-color: #fff; color: #66bb6a; padding: 12px 25px; border-radius: 50px; text-decoration: none; font-weight: bold; font-size: 16px; display: inline-block;">Join Now</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function updatePrice(plan) {
            if (plan === "monthly") {
                ...
                document.getElementById("standard-plan-price").innerText = "₹100/Monthly";
            } else {
                document.getElementById("price-display").innerText = "₹1000/Yearly";
                document.getElementById("standard-plan-price").innerText = "₹1000/Yearly";
            }
        }
    </script>
