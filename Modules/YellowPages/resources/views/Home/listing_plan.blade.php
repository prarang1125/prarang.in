...
<br><br>
    ...
    <div style="text-align: center; padding: 20px;">
        ...
        <div style="display: flex; justify-content: center; margin-bottom: 20px;">
            <button class="btn btn-primary" style="margin-right: 5px;">व्यावसायिक योजनाएं</button>
            <button class="btn btn-outline-primary" style="margin-right: 5px;">बाज़ार योजनाएँ</button>
