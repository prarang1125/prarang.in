              ...
              <form action="{{ route('yp.authLogin') }}" method="POST" class="sign-in-form" autocomplete="off">
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <input type="tel" class="form-control @error('phone') is-invalid @enderror" name="phone" placeholder="फोन नंबर दर्ज करें" value="{{ old('phone') }}" required />
                  </div>
                  @error('phone')
                    <div class="text-danger small">{{ $message }}</div>
                  @enderror
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group">
                    ...
                    <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="पासवर्ड दर्ज करें" required />
                  </div>
                  @error('password')
                    <div class="text-danger small">{{ $message }}</div>
                  @enderror
