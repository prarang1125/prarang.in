...
<head>
  ...
  <meta property="og:description"
    content="@yield('meta_og_description', 'Connect with ' . ($user->name ?? 'this business') . ' via digital WebPage.')">
...
<body>
  <div
    ...
    <div
      class="bg-white rounded-2xl shadow-lg overflow-hidden max-w-md w-full transform hover:scale-105 transition-transform duration-300 ring-2 ring-indigo-400 hover:ring-4 hover:ring-indigo-500">
      ...
      <div class="flex flex-col md:flex-row relative">
        ...
        <div class="p-3 flex-1 space-y-2">
          ...
          <div class="space-y-1 mb-3">
            <div class="flex items-center space-x-2 p-1 hover:bg-gray-50 rounded transition-colors">
              ...
              <span class="text-gray-500 text-xs">{{ __('formyp.name_label') }}:</span>
          ...
          <div class="flex items-center space-x-2 p-1 hover:bg-gray-50 rounded transition-colors">
            ...
            <span class="text-gray-700 text-xs">{{ __('formyp.address_label') }}:</span>
          ...
          <div class="p-2 hover:bg-gray-50 rounded-lg transition-colors">
            <span class="text-gray-500 text-sm">
              {{ $social->title ?? __('yp.social_media') }}:
              <span class="text-gray-700 font-semibold">
                ...
                <a href="https://wa.me/{{ $socialData }}" target="_blank" class="text-green-500 hover:underline">{{
                  $socialData }}</a>
                @else
        ...
        <div class="bg-gradient-to-b from-indigo-50 to-white p-4 flex flex-col items-center justify-between md:w-28">
          ...
          <!-- QR Code -->
          <div
            class="w-24 h-24 bg-white p-2 rounded-xl shadow-md transform hover:rotate-3 transition-transform duration-300">
            <img
