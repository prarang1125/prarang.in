            ...
            <div class="col-xl-9 mx-auto">
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        ...
                        <p class="mb-4">{{ __('formyp.edit_listing_sub') }}</p>
                        <hr>
                        ...
                        <form action="{{ route('vCard.listing-update', $listing->id) }}" method="POST" id="listingForm"
                                ...
                                <select id="location" class="form-select @error('location') is-invalid @enderror"
                                    ...
                                    @foreach ($cities as $city)
                                        <option value="{{ $city->id }}"
                                            {{ old('location', $listing->city_id) == $city->id ? 'selected' : '' }}>
                                            {{ $city->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="toggleTagline"
                                        {{ $listing->tagline ? 'checked' : '' }} onclick="toggleTaglineField()">
                            ...
                            <div class="col-md-12" id="taglineField"
                                ...
                                <input type="text" class="form-control @error('tagline') is-invalid @enderror"
                                    id="tagline" name="tagline" value="{{ old('tagline', $listing->tagline) }}"
                                ...
                                <select id="businessType" class="form-select @error('businessType') is-invalid @enderror"
                                    ...
                                    @foreach ($company_legal_type as $type)
                                        <option value="{{ $type->id }}"
                                            {{ old('businessType', $listing->legal_type_id) == $type->id ? 'selected' : '' }}>
                                            {{ $type->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select id="employees" class="form-select @error('employees') is-invalid @enderror"
                                    ...
                                    @foreach ($number_of_employees as $range)
                                        <option value="{{ $range->id }}"
                                            {{ old('employees', $listing->employee_range_id) == $range->id ? 'selected' : '' }}>
                                ...
                                <select id="turnover" class="form-select @error('turnover') is-invalid @enderror"
                                    ...
                                    @foreach ($monthly_turnovers as $turnover)
                                        <option value="{{ $turnover->id }}"
                                            {{ old('turnover', $listing->turnover_id) == $turnover->id ? 'selected' : '' }}>
                                            {{ $turnover->name ?? $turnover->range }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('turnover')
                                ...
                                <select id="advertising" class="form-select @error('advertising') is-invalid @enderror"
                                    ...
                                    @foreach ($monthly_advertising_mediums as $medium)
                                        <option value="{{ $medium->id }}"
                                            {{ old('advertising', $listing->advertising_medium_id) == $medium->id ? 'selected' : '' }}>
                                            {{ $medium->name ?? $medium->medium }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('advertising')
                                ...
                                <select id="advertising_price"
                                    ...
                                    @foreach ($monthly_advertising_prices as $price)
                                        <option value="{{ $price->id }}"
                                            {{ old('advertising_price', $listing->advertising_price_id) == $price->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="category" class="form-select @error('category') is-invalid @enderror"
                                    ...
                                    @foreach ($categories as $cat)
                                        <option value="{{ $cat->id }}"
                                            {{ old('category', $listing->category_id) == $cat->id ? 'selected' : '' }}>
                                            {{ $cat->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="url" class="form-control @error('website') is-invalid @enderror"
                                    id="website" name="website" value="{{ old('website', $listing->website) }}"
                            ...
                            <div class="col-md-12">
                                <label for="business_address"
                                    class="form-label">{{ __('formyp.business_address') }}</label>
                                <input type="text"
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                    rows="4" placeholder="{{ __('formyp.enter_description') }}">{{ old('description', $listing->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select name="day[]" class="form-select form-select-sm">
                                                    @foreach (['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'] as $dayName)
                                                        ...
                                                        @endphp
                                                        <option value="{{ $dayLower }}"
                                                            {{ $selectedDay == $dayLower ? 'selected' : '' }}>
                                                            {{ __('formyp.' . $dayLower) }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-2 text-center">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        {{ old('is_24_hours.' . $index, is_string($hour) ? false : $hour->is_24_hours) ? 'checked' : '' }}>
                                                    <label
                                                        class="form-check-label small">{{ __('formyp.24_hours') }}</label>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="file" class="form-control @error('image') is-invalid @enderror"
                                    ...
                                    onchange="previewMedia(this, 'coverPreview')">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="file" class="form-control @error('logo') is-invalid @enderror"
                                    ...
                                    onchange="previewMedia(this, 'logoPreview')">
                            ...
                            <div class="col-12 mt-5">
                                <div class="d-grid">
                                    <button type="submit"
                                        class="btn btn-primary px-5">{{ __('formyp.update_listing_btn') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
