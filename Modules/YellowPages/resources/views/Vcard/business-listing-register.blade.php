                    ...
                    <form action="{{ route('yp.listing.store') }}" method="POST" id="listingForm"
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="location" class="form-select @error('location') is-invalid @enderror"
                                ...
                                <option value="{{ $city->id }}" {{ old('location', $user->city_id) == $city->id ?
                                    'selected' : '' }}>
                                    {{ $city->name }}
                                </option>
                                @endforeach
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="businessType" class="form-select @error('businessType') is-invalid @enderror"
                                ...
                                <option value="{{ $type->id }}" {{ old('businessType')==$type->id ? 'selected' : '' }}>
                                    {{ $type->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="employees" class="form-select @error('employees') is-invalid @enderror"
                                ...
                                <option value="{{ $range->id }}" {{ old('employees')==$range->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="turnover" class="form-select @error('turnover') is-invalid @enderror"
                                ...
                                <option value="{{ $turnover->id }}" {{ old('turnover')==$turnover->id ? 'selected' : ''
                                    }}>
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="advertising" class="form-select @error('advertising') is-invalid @enderror"
                                ...
                                <option value="{{ $medium->id }}" {{ old('advertising')==$medium->id ? 'selected' : ''
                                    }}>
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="advertising_price"
                                ...
                                <option value="{{ $price->id }}" {{ old('advertising_price')==$price->id ? 'selected' :
                                    '' }}>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control @error('street') is-invalid @enderror" id="street"
                                name="street" value="{{ old('street') }}" placeholder="{{ __('formyp.road_street') }}">
                            @error('street')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-3">
                            <label for="city_id" class="form-label">{{ __('yp.cities') }}</label>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description"
                                ...
                                placeholder="{{ __('formyp.enter_description') }}">{{ old('description') }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                ...
                                <div class="row g-2 mb-3 align-items-end working-hour-row">
                                    <div class="col-md-3">
                                        ...
                                        <select name="day[]" class="form-select form-select-sm">
                                            ...
                                            <option value="{{ strtolower($day) }}" {{ $dayValue==strtolower($day)
                                                ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-2 text-center">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox"
                                                ...
                                                $index) ? 'checked' : '' }}>
                                            <label class="form-check-label small" for="is_24_hours">{{
                                                __('formyp.24_hours') }}</label>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="row g-2 mb-3 align-items-end social-media-row">
                                    <div class="col-md-4">
                                        ...
                                        <select name="socialId[]" class="form-select form-select-sm">
                                            ...
                                            <option value="{{ $platform->id }}" {{ $socialId==$platform->id ? 'selected'
                                                : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="socialDescription[]"
                                            ...
                                            value="{{ old('socialDescription.' . $index) }}" placeholder="https://...">
                                    </div>
                                    <div class="col-md-2">
                                        <button type="button" class="btn btn-sm btn-outline-danger"
                                            onclick="removeRow(this)">
                        ...
                        <div class="col-12 mt-4">
                            <div class="form-check">
                                <input class="form-check-input @error('agree') is-invalid @enderror" type="checkbox"
                                    id="agree" name="agree" value="1" {{ old('agree') ? 'checked' : '' }}>
                        ...
                        <div class="col-12 mt-5">
                            <div class="d-grid">
                                <button type="submit" class="btn btn-primary px-5">{{ __('formyp.submit_btn')
                                    }}</button>
                            </div>
                        </div>
                    </form>
