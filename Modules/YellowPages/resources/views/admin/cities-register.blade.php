                    ...
                    <form action="{{ route('admin.cities-store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('portal_id') is-invalid @enderror" id="portal_id"
                                    name="portal_id">
                                    <option value="" disabled selected>पोर्टल का चयन करें</option>
                                    @foreach ($portals as $portal)
                                        <option value="{{ $portal->id }}"
                                            {{ old('portal_id') == $portal->id ? 'selected' : '' }}>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <label for="inputimage" class="form-label">Slug</label>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <label for="inputimage" class="form-label">City Short Code (Station Code)</label>
                                <input type="text" class="form-control @error('city_arr') is-invalid @enderror"
                                    name="city_arr" placeholder="Meerut -> mrt">
                                @error('city_arr')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <label for="inputimage" class="form-label">City Slug (English)</label>
