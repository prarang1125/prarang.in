            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">शहर संपादित करें</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card" style="padding-top: 15px;">
                <div class="col-xl-9 mx-auto w-100">
                    <div class="col-xl-9 mx-auto w-100">
                        ...
                        @endif
                        <h6 class="mb-0 text-uppercase">शहर संपादित करें</h6>
                        <hr />
                        <form action="{{ route('admin.cities-update', $cities->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="inputName" name="name" value="{{ old('name', $cities->name) }}">
                                    @error('name')
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6 mt-2">
                                    @if ($cities->cities_url)
                                        <img src="{{ Storage::url($cities->cities_url) }}" alt="{{ $cities->name }}"
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <label for="inputImages" class="form-label">cover Image ( छवि) (1200X500 px)</label>
                                    <input type="file" class="form-control @error('cover') is-invalid @enderror"
                                        id="inputImages" name="cover">
                                    @error('cover')
                                        <p class="invalid-feedback">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="col-md-6 mt-2">
                                    @if ($cities->cover)
                                        <img src="{{ Storage::url($cities->cover) }}" alt="{{ $cities->name }}"
