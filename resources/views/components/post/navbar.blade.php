<section>
  ...
  .prangtxt + strong {
    ...
    background: #8e8888;
    color: white;
    margin-left: 10px; /* Add some space from the previous element */
}
/* Container fluid */
...
/* Modal body */
#cultureModal .modal-dialog .modal-body, #natureModal .modal-dialog .modal-body{
 width:100%;
}

/* Heading */
#cultureModal a h6, #natureModal a h6{
 margin-bottom:0px;
 font-weight:400;
 color:#020202;
...
/* Column 10/12 */
#cultureModal a .tagListx, #natureModal a .tagListx{
 border-style:none !important;
 text-align:left;
}

/* Rounded circle */
#cultureModal .tagListx .rounded-circle, #natureModal .tagListx .rounded-circle{
 padding-left:5px;
 padding-right:15px;
 color:#020202;
 text-decoration:none;
...
/* Img fluid */
#cultureModal a .img-fluid, #natureModal a .img-fluid{
 border-style:solid;
 border-color:#cdc5c5;
}
                    ...
                    <div class="col-sm-4">
                        <p class="border-bottom">
                            ...
                            <div class="mb-1">
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <img class="img-fluid rounded-circle" src="https://{{$tag->tagIcon}}" alt="">
                                    </div>
