<div>
   ...
   <div class="flex flex-col sm:flex-row justify-center items-stretch gap-4 my-4">
    ...
    <!-- Box 1 -->
    <div class="text-center w-full sm:w-1/3 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden pt-6 flex flex-col justify-center items-center">
                ...
                <div class="modal-content rounded shadow-lg">
                    ...
                    <div class="modal-body px-4 pb-4 pt-2 border-t">
                        <p class="text-dark fs-5 mb-4 text-lg">
                            ...
                            Connections, this is awaited for a Partnership.
                        </p>
                        <div class="flex flex-col sm:flex-row justify-center items-center gap-3 mt-3">
                            <a href="https://www.prarang.in/partners" target="_blank"
                                class="btn text-white text-sm px-3 py-2 shadow-sm bg-blue-500 hover:bg-blue-600 hover:text-white w-full sm:w-auto text-center">
    ...
    <!-- Box 2 -->
    <div class="text-justify w-full sm:w-2/3 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden p-4 flex flex-col justify-between">
        <h2 class="text-lg font-extrabold text-slate-800 text-center mb-2">Shared History</h2>
