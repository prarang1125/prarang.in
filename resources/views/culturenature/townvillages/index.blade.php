    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div class="lg:col-span-3  space-y-6 order-3 lg:order-1">
            ...
            <div class="bg-white rounded-2xl border border-green-200 shadow-sm overflow-hidden mb-6">
                ...
                <div class="px-6 pb-8 space-y-1" x-data="{ active: null }">
                    @php
                    $logistics = [
                    ['icon' => '🗺️', 'label' => 'Village Map', 'link' => 'https://maps.app.goo.gl/BX755J215dehzQgx7'],
                    ...
                    ['icon' => '🍴', 'label' => 'Restaurants / Dhabas', 'link' =>
                    ...
                    ['icon' => '🏙️', 'label' => 'Nearest City', 'value' => 'Aonla', 'link' => 'https://aonla.com'],
                    ['icon' => '🚌', 'label' => 'Bus Stop', 'link' => 'https://maps.app.goo.gl/rkvnhjKtmbcYtrDa9'],
                    ['icon' => '🚆', 'label' => 'Railway', 'value' => 'Aonla Station', 'link' =>
                    'https://www.easemytrip.com/railways/aonla-ao-railway-station/'],
                    ['icon' => '🛫', 'label' => 'Nearest Airport', 'value' => 'Bareilly Airport', 'link' =>
                    'https://www.aai.aero/en/airports/bareilly'],
                    ['icon' => '🏨', 'label' => 'Nearest Hotels', 'value' => 'Hotels in Aonla', 'link' =>
                    'https://www.makemytrip.com/hotels/aonla-hotels.html'],
                    ];
                    @endphp
                    @foreach($logistics as $index => $item)
                    <div class="border-b border-gray-50 last:border-0">
                        @if(!isset($item['value']))
                        <a href="{{  $village['village']['Town_Village']==129823 ? $item['link'] : '#' }}"
                            {{ $village['village']['Town_Village']==129823 ? 'target="_blank"' : '' }}
                        ...
                        <div x-show="active === {{ $index }}" x-collapse x-cloak class="ml-9 pb-2">
                            @if($village['village']['Town_Village']==129823)
            ...
            <div class="bg-white rounded-2xl border border-green-200 shadow-sm overflow-hidden mb-6">
                ...
                <div class="px-6 pb-6 space-y-2" x-data="{ active: null }">
                    @php
                    $amenityGroups = [
                    ['icon' => '🏥', 'label' => 'Hospitals / Medical', 'items' => [['name' => 'Ram Nagar CHC', 'link' =>
                    'https://maps.app.goo.gl/jd12CdUsMYd7yZ2T6']]],
                    ['icon' => '👮', 'label' => 'Police Stations', 'items' => [['name' => 'Police Chowki Ram Nagar',
                    'link' => 'https://maps.app.goo.gl/AYNepRCAVnWd9KNG8']]],
                    ['icon' => '⛽', 'label' => 'Petrol Pumps', 'items' => [
                    ['name' => 'HPCL', 'link' => 'https://maps.app.goo.gl/RLcVexBtUs7Tk5Wy5'],
                    ['name' => 'IndianOil', 'link' => 'https://maps.app.goo.gl/SiwTzw91itdcSUhg7']
                    ]],
                    ['icon' => '🏧', 'label' => 'ATMs', 'items' => [
                    ...
                    ['icon' => '🏦', 'label' => 'Bank Branches', 'items' => [
                    ['name' => 'Union Bank of India', 'link' => 'https://maps.app.goo.gl/ngFZ6KvVgdfMH3ZZ7'],
                    ['name' => 'Bank of Baroda', 'link' => 'https://maps.app.goo.gl/8hsRabHjr9mQb8nQ7'],
                    ['name' => 'Punjab National Bank', 'link' => 'https://maps.app.goo.gl/Erjw4bmk2fdYnhce8']
                    ]],
                    ['icon' => '📮', 'label' => 'Post Offices', 'items' => [['name' => 'Ram Nagar S.O.', 'link' =>
                    'https://pin-code.org/india/uttar-pradesh/bareilly/ram-nagar/']]],
                    ['icon' => '🎓', 'label' => 'Schools / Colleges', 'items' => [
                    ['name' => 'Jain Academy', 'link' =>
                    'https://stackschools.com/schools/09200106207/jain-academy-english-medium-school'],
                    ['name' => 'Ch.Kashiram Yadav Inter College', 'link' =>
                    'https://stackschools.com/schools/09200106206/ch-kashiram-yadav-inter-college']
                    ]],
                    ['icon' => '🏢', 'label' => 'Government Offices', 'items' => [
                    ['name' => 'BDO Ramnagar', 'link' => 'https://maps.app.goo.gl/GNt6SzC1Grhvjvpu9'],
                    ['name' => 'Kshetra Panchayat', 'link' => 'https://maps.app.goo.gl/vYK6uY949xXiyi3P6']
                    ]],
                    ];
                    @endphp
        ...
        <div class="lg:col-span-6 space-y-6  order-1 lg:order-2">
            ...
            <div class="rounded-2xl overflow-hidden border border-gray-100 shadow-sm transition-all hover:shadow-md">
                <img src="{{asset('assets/images/rural_states/'.$village['state']['state_LGD_code'])}}.jpg"
                        ...
                        <div class="w-full space-y-2">
                            @for($i=1; $i<=2; $i++) <div class="flex gap-4 group/entry cursor-default">
                                <div
                                    ...
                                    <span class="text-[10px] font-bold text-gray-400">Image {{$i}}</span>
                                </div>
                                <div
                                    ...
                                    <span class="text-sm font-bold text-gray-800">Culture Insight {{$i}}</span>
                                </div>
                        </div>
                        @endfor
                    </div>
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="w-full space-y-2">
                        @for($i=1; $i<=2; $i++) <div class="flex gap-4 group/entry cursor-default">
                            ...
                            <div
                                class="flex-grow bg-white border border-slate-100 rounded-2xl px-6 flex items-center shadow-sm transition-all group-hover/entry:border-slate-200">
                                <span class="text-sm font-bold text-gray-800">Nature Insight {{$i}}</span>
                            </div>
                    </div>
                    @endfor
                </div>
    ...
    <div class="lg:col-span-3 space-y-6  order-2 lg:order-3">
        ...
        <div
            ...
            <div class="divide-y divide-gray-50">
                @php
                $details = [
                ['label' => 'Gram Panchayat', 'value' => $village['gram_panchayat']['local_body_name_en'] ?? '-'],
                ['label' => 'Sub-District (Tehsil)', 'value' => $village['gram_panchayat']['subdistrict_name_en'] ?? '-'],
                ];
                @endphp
        ...
        <div
            ...
            <div class="divide-y divide-gray-50">
              ...
              $village['internet_users']['district_int_users']],
                ...
                <div class="flex justify-between items-center px-4 py-2 hover:bg-gray-50/30 transition-colors">
                    <span class="text-[13px] font-medium text-gray-500">{{ $trend['label'] }} <x-source source="{{ $trend['source'] }}" /></span>
        ...
        <div class="bg-white rounded-2xl p-2 px-8 border border-gray-100 shadow-sm transition-all hover:shadow-md">
            <div class="flex flex-col items-center mb-10">
                       ...
                       <h3 class="text-base text-center font-bold text-blue-600">{{ $village['district']['district_name'] }}
                    Analytics</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-1 gap-8">
                ...
                <div
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <a  target="_blank" href="https://g2c.prarang.in/india/market-planner/states?city={{ $village['district']['dhq_code'] }}"
                        ...
                        <a target="_blank" href="https://g2c.prarang.in/india/development-planners?city={{ $village['district']['dhq_code'] }}"
                            class="flex items-center justify-center py-2.5 bg-white border border-slate-200 text-xs font-bold text-slate-700 rounded-xl hover:bg-indigo-600 hover:text-white hover:border-slate-900 transition-all shadow-sm">
                            Development
                        </a>
                    </div>
                ...
                <div
                   ...
                   <a target="_blank" href="https://g2c.prarang.in/ai/bareilly">
