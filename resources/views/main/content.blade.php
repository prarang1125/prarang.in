  ...
  main .btn-warning{
   ...
   <div class="modal fade modal-xl" id="TheseMTw1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="TheseMTw1Label" aria-hidden="true">
    <div class="modal-dialog">
      ...
      <div>
          <p>
              <strong class="text-primary">Daily City Posts - Free Subscription – </strong><a class="links style-TYdFv" href="https://www.facebook.com/prarang.in" target="_blank" contenteditable="false" id="style-TYdFv">FB Page</a>, <a class="links style-wDEqa" href="https://play.google.com/store/apps/details?id=com.riversanskiriti.prarang" target="_blank" contenteditable="false" id="style-wDEqa">Mobile App</a> ( Coming soon – X, eMail, Instagram, Whatsapp, Sharechat )
          </p>
      </div>
          ...
          <div class="col-md-4 col-xs-12">
              <div class="col-md-12 col-xs-12 reorganize live-content">
                  ...
                  <ul>
                      ...
                      <li> New &amp; localized visual iconography for new netizens &amp; first-time smartphone users. </li>
                  </ul>
              </div>
          </div>
          <div class="col-md-4 col-xs-12">
              <div class="col-md-12 col-xs-12 reorganize style-A23aK live-content" id="style-A23aK">
                  ...
                  <ul>
                      ...
                      <li> Decrease in digital noise - Focused content to reduce digital distractions &amp; negativity of news </li>
