      ...
      <section class="text-center">
          <div class="row">
              <div class="col-sm-6">
                ...
                <a class="btn btn-lg btn-warning border border-danger w-50" target="_blank" href="https://b2b.prarang.in/login">Partnership (B2B) Login</a>
            </div>
              </div>
              <div class="col-sm-6">
          ...
          <p class="h5 text-start">Live City Knowledge Webs  - Reach & Market Size :</h3>
            <div class="row mb-2">
                    ...
                    <div class="col-sm-2">
                          <a href="https://b2b.prarang.in/ads/YzI=" target="_blank" class="btn btn-sm btn-warning w-75">Meerut</a>
                    </div>
                    <div class="col-sm-2">
                          <a href="https://b2b.prarang.in/ads/YzM=" target="_blank" class="btn btn-sm btn-warning w-75">Rampur</a>
                    </div>
                      <div class="col-sm-2">
                          <a href="https://b2b.prarang.in/ads/cjQ=" target="_blank" class="btn btn-sm btn-warning w-75">Jaunpur</a>
                    </div>
                    </div>
                     <div class="row">
                    <div class="col-sm-2 text-center">
                    ...
                    <div class="col-sm-2">
                          <a href="https://b2b.prarang.in/ads/content/YzI=" target="_blank" class="btn btn-sm btn-warning w-75">Meerut</a>
                    </div>
                    <div class="col-sm-2">
                          <a href="https://b2b.prarang.in/ads/content/YzM=" target="_blank" class="btn btn-sm btn-warning w-75">Rampur</a>
                    </div>
                      <div class="col-sm-2">
                          <a href="https://b2b.prarang.in/ads/content/cjQ=" target="_blank" class="btn btn-sm btn-warning w-75">Jaunpur</a>
                    </div>
                    </div>
      </section>
    ...
    <div class="modal fade" id="requestTomeet" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="requestTomeetLabel" aria-hidden="true">
     ...
     <div class="modal fade modal-xl" id="TheseMTw1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="TheseMTw1Label" aria-hidden="true">
      <div class="modal-dialog">
          ...
          <div class="modal-body">
           ...
           <div class="row">
            <div class="col-md-6">
                ...
                <ol>
                    <li><b>City Partner Exclusive Login Access </b>- 5 Employee/Biz Partner Ids - For the duration of Partnership</li>
                    <li><b>City Subscribers & City Portal -</b> Live 10,000+ FB & Mobile App Subscribers + City Portal with 60+ Posts</li>
                    <li><b> Exclusive Ad insert in Daily Post -</b> Prarang FB Page/Mobile App - Upto 27 Still & 4 Videos, Per Month</li>
                    <li><b> Sponsored Ad - </b> FB Page - Upto 27 Still & 4 Videos, Per Month</li>
                    <li><b> Exclusive Partnership on City Portal & Prarang.in - </b> Partnership Ad Placement - For the duration of Partnership</li>
                    <li><b> Analytics -</b>
                        <ul>
                            <li>(a) City Digital Demographics </li>
                            <li>(b) Prarang Monthly Performance Analytics & Daily Post Analytics </li>
                            <li>(c) City Metrics & City Planners - Exclusive access to Updated Socio-Economic & Culture-Nature metrics</li>
                        </ul>
                    </li>
                    <li> <b>Semiotics -</b>
                        <ul>
                            <li>(a) Exclusive daily insights on Readership - City Mood </li>
                            <li>(b) Exclusive daily insights on Readership - Culture-Nature, Work, Education & Global-Local</li>
                        </ul>
                    </li>
                    <li><b> Impact -</b>
                        <ul>
            ...
            <div class="col-md-6 ">
                <p class="text-primary h6">Add On Products (Optional) – Based on request for Activation :</p>
                <ol>
                    ...
                    <li><b> Business Survey -</b> Yellow Pages & e-Cards Activation Project - Month/Year ; Frequency</li>
                </ol>
            </div>
        </div>
       ...
       <div class="modal fade modal-xl" id="TheseMTi1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="TheseMTi1Label" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <!-- <h1 class="modal-title fs-5" id="TheseMTLabel">Modal title</h1> -->
         ...
         <section class="container mt-3">
            <p>
                The mobile internet provides a more targeted & cost-effective option vis-à-vis traditional forms of
                Advertising ( Newspapers, Outdoors, Radio/TV etc) . Yet, few hyperlocal digital solutions have emerged for
                advertisers thus far, as contextualized <span class="text-primary"> hyperlocal language content </span>
                continues to
                be scarce, in an English language driven internet. With Prarang <span class="text-primary"> daily , local
                    language city content</span> creation, we attempt to fill that gap. Alongside, it opens a <span
                    class="text-primary"> new digital advertising </span> opportunity Additionally, with the daily benefit
                of unique
                City semiotic insights, a quantum leap in advertising is now possible. With the <span class="text-primary">
                    ...
                    <div class="col-md-6">
                        <ul>
                            ...
                            <ul>
                                ...
                                <li>Track competitive advertising across traditional media & industry</li>
                            </ul>
