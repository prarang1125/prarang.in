<x-layout.main.base>
    <section class="container mt-3 p-2">
        ...
        <p>
            ...
            information Technology Act, 2000 and the rules made there under and the amended provisions pertaining to
        ...
        <p>
            This Privacy Policy is a legally binding document between you and Prarang (both terms defined below). The
            terms of this Privacy Policy will be effective upon your acceptance of the same (directly or indirectly in
            electronic form, by clicking on the ‘Accept Terms and Conditions’ tab or by use of the website or by other
            means) and will govern the relationship between you and Prarang for your use of the website “www.prarang.in”
            (defined below).
        </p>
        <p>
        ...
        <p>
            ...
            registration process namely: - a) your name, b) email address, c) age, d) PIN code, e) credit card or debit
            card details f) education/organization records and history g) sexual orientation, h) biometric information,
            i) password etc., and / or your occupation, interests, and the like. The Information as supplied by the
        ...
        <ul>
            ...
            <li><strong>Personal information such as your name, email address, and location (as provided by
                    you)</strong></li>
        </ul>
        <strong>COOKIES</strong>
        </p>
        <p>
            To improve the responsiveness of the sites for our users, we may use "cookies", or similar electronic tools
            to collect information to assign each visitor a unique, random number as a User Identification (User ID) to
            understand the user's individual interests using the Identified Computer. Unless you voluntarily identify
            yourself (through registration, for example), we will have no way of knowing who you are, even if we assign
            a cookie to your computer. The only personal information a cookie can contain is information you supply. A
            cookie cannot read data off your hard drive.
        </p>
        <p>
            ...
            attached to the Internet know where to send you data -- such as the web pages you view.) Your IP address
            does not identify you personally. We use this information to deliver our web pages to you upon request, to
            tailor our site to the interests of our users, to measure traffic within our site and let Prarang know the
        ...
        <p>
            ...
            processing practices and security measures, including appropriate encryption and physical security measures
        ...
        <p>
            ...
            intercepted while being transmitted to us over the Internet. And, of course, any information you include in
            a posting to the discussion areas is available to anyone with Internet access.
        ...
        <p>
            Redressal Mechanism: Any complaints, abuse or concerns with regards to content and or comment or breach of
            these terms shall be immediately informed to the designated Grievance Officer as mentioned below via in
            writing or through email signed with the electronic signature to

        </p>
        <p>
            <!--<strong>Mr. Subodh Kumar</strong>-->
        </p>
        <p><strong>www.prarang.in</strong>
        </p>
