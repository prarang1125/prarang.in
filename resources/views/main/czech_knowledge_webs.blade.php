...
<x-layout.main.base :metaData="$metaData">
    ...
    <section class="bg-gray-50 py-4 czech-webs">
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="modern-card">
                        ...
                        <div class="p-3 card-links">
                            <a href="https://g2c.prarang.in/Czech-Republic?data=1" target="_blank" class="blue-btn">
                                MULTILATERAL DATA
                            </a>


                            <a href="https://g2c.prarang.in/czech-republic?data" target="_blank" class="blue-btn">
                                NATIONAL DATA
                            </a>
                            ...
                            <a href="javascript:void(0);" class="blue-btn noanime">CZECH LOCALISATION</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="modern-card">
                        ...
                        <div class="p-3 card-links">
                            {{-- <a href="https://g2c.prarang.in/ai/czech-republic" target="_blank" class="yellow-btn">COUNTRY AI REPORT</a> --}}

                            <a href="javascript:void(0);" class="yellow-btn" data-bs-toggle="modal"
                                data-bs-target="#czechRegionsModal">
                                CZECH-REPUBLIC AI REPORT
                            </a>

                            <a href="https://www.prarang.in/india-czech-republic/all-posts" target="_blank" class="yellow-btn">BILATERAL - INDIA</a>
                            <a href="javascript:void(0);" class="yellow-btn noanime">CZECH LOCALISATION</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="modern-card">
                        ...
                        <div class="p-3 card-links noanimation">
                            ...
                            <a href="javascript:void(0);" class="red-btn">REGIONAL IMAGES</a>
                            <a href="javascript:void(0);" class="red-btn">CULTURE / NATURE IMAGES</a>
                            <a href="javascript:void(0);" class="red-btn">CZECH LOCALISATION</a>
                        </div>
                    </div>
                </div>
