...
<head>
    ...
    <style>
        ...
        *,
        ...
        #style-fEfpa.style-fEfpa {
            animation-delay: 0ms;
        }

        #style-eParL.style-eParL {
            animation-delay: 200ms;
        }

        #style-9dE7T.style-9dE7T {
...
<body>
    ...
    <!-- Exported with SnipCSS extension (Ver 1.9.8) -->
    <div class="min-h-screen bg-white snipcss-tpTBy">
        <header
            class="bg-gradient-to-r from-yellow-400 to-yellow-300 py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden snipcss0-0-0-1 tether-element-attached-top tether-element-attached-center tether-target-attached-top tether-target-attached-center">
            ...
            <div class="max-w-7xl mx-auto text-center relative snipcss0-1-1-3">
                ...
                <div class="mt-8 flex justify-center space-x-6 animate-fade-in snipcss0-2-3-7">
                    <div class="flex items-center space-x-2 snipcss0-3-7-8"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            class="lucide lucide-users w-6 h-6 text-yellow-700 snipcss0-4-8-9">
                    ...
                    <div class="flex items-center space-x-2 snipcss0-3-7-11"><svg xmlns="http://www.w3.org/2000/svg"
                            width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-building2 w-6 h-6 text-yellow-700 snipcss0-4-11-12">
                    ...
                    <div class="flex items-center space-x-2 snipcss0-3-7-14"><svg xmlns="http://www.w3.org/2000/svg"
                            width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-star w-6 h-6 text-yellow-700 snipcss0-4-14-15">
                            <polygon
                    ...
                    <div class="space-y-6 animate-slide-right snipcss0-3-3-4">
                        ...
                        <div class="space-y-4 snipcss0-4-4-7">
                            <div class="flex items-center space-x-3 snipcss0-5-7-8"><svg
                                    ...
                                    class="lucide lucide-search w-6 h-6 text-yellow-500 snipcss0-6-8-9">
                                    <circle cx="11" cy="11" r="8"></circle>
                                    <path d="m21 21-4.3-4.3"></path>
                                </svg><span class="text-gray-600 snipcss0-6-8-10">आसान खोज और फ़िल्टर</span></div>
                            <div class="flex items-center space-x-3 snipcss0-5-7-11"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round"
                                    class="lucide lucide-clock w-6 h-6 text-yellow-500 snipcss0-6-11-12">
                ...
                <div class="space-y-6 animate-slide-left">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center space-x-3"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                stroke-linejoin="round" class="lucide lucide-map-pin w-6 h-6 text-yellow-500">
                                <path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"></path>
                                <circle cx="12" cy="10" r="3"></circle>
                            </svg><span class="text-gray-600">मेरठ, उत्तर प्रदेश, भारत</span></div>
                        <div class="flex items-center space-x-3"><svg xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-phone w-6 h-6 text-yellow-500">
                                <path
                ...
                <div class="text-right animate-fade-in">
                    ...
                    {{-- <div class="flex justify-end space-x-4"><a href="#"
                            class="hover:text-yellow-500 transition-colors transform hover:scale-110"><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-facebook w-6 h-6">
                                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                            </svg></a><a href="#"
                            class="hover:text-yellow-500 transition-colors transform hover:scale-110"><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-twitter w-6 h-6">
                                <path
                            ...
                            class="hover:text-yellow-500 transition-colors transform hover:scale-110"><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-instagram w-6 h-6">
