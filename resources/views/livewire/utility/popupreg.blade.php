<div wire:ignore.self class="modal fade" id="popupregister" tabindex="-1" aria-labelledby="registerModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <form wire:submit.prevent="{{ $step === 1 ? 'nextStep' : 'register' }}">
                    ...
                    @if ($step === 2)
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" id="interested"
                ...
                <div class="modal-footer">
                    @if ($step === 1)
                        <button type="submit" class="btn btn-primary" wire:target="nextStep"
                    ...
                    @else
                        <button type="submit" class="btn btn-success" wire:target="register"
                            wire:loading.attr="disabled">
                            <span wire:loading.class.remove="d-none"
                                class="spinner-border spinner-border-sm d-none"></span>
