<div>
    ...
    <div style="position: fixed; inset: 0; z-index: 9999; display: flex; align-items: center; justify-content: center;">
        ...
        {{-- Modal Box --}}
        <div style="position: relative; background: #fff; border-radius: 8px; width: 800px; max-width: 95vw; box-shadow: 0 10px 40px rgba(0,0,0,0.3); z-index: 1;">
            {{-- Header --}}
            ...
            <div style="padding: 24px; min-height: 100px; max-height: 75vh; overflow-y: auto;" class="custom-scroll">
                ...
                <p class="">SCEH Hospitals and Vision Centers located within this district are displayed below, categorized by city and village locations. You may click the button below to visit the District Capital's web page partnered with SCEH. <br>
                        ...
                        <table class="table table-hover table-striped table-sm m-0 border-0 align-middle text-sm" style="width:100%;">
                            ...
                            <tbody>
                                ...
                                <tr class="transition-colors hover:bg-blue-100">
                                    ...
                                    <td class="py-2 px-3 font-medium text-gray-800"><a target="_blank" href="{{ $items['h_link'] }}">{{ $items['sceh_eye_care'] }} &nbsp;({{ $items['h_type'] }})</a></td>
                                    <td class="py-2 px-3 text-center text-gray-500">{{ $items['ph_no'] }}</td>
                                    <td class="py-2 px-3  text-gray-500">{{ $items['address'] }}</td>
                                    <td class="py-2 px-3 text-center text-gray-500"><a href="{{ $items['map_link'] }}" target="_blank">Click Here</a></td>
