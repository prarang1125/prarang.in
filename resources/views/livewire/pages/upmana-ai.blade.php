<div>
    ...
    <style>
        ...
        /* Text center */
        .container:nth-child(2) div:nth-child(1) .container-fluid>.text-center:nth-child(1) {
    ...
    <button class="@if ($output) d-none @endif btn btn-primary side-button" type="button" data-bs-toggle="offcanvas"
        data-bs-target="#openFaqExample" aria-controls="openFaqExample">
        &nbsp;&nbsp;FAQ &nbsp;&nbsp;
    </button>
            ...
            <div class="@if ($output) col-12 @else  col-lg-9 col-md-9 col-sm-12 @endif position-relative">
                ...
                <div class="pr-ai-section">
                                        ...
                                        <div class="main-button-area">
                                            <div class="select-location">
                                                <div> <button type="button"
                                                        ...
                                                        {{ $lables['select_location'] }}<br><small>{{ $lables['2_to_5']
                                                            }}</small>
                                                    </button>
                                            ...
                                            <div class="select-category">
                                                <div> <button type="button"
                                                        ...
                                                        {{ $lables['select_metrics'] }}<br><small>{{ $lables['2_to_5']
                                                            }}</small>
                                                    </button></div>
                    ...
                    <section class="p-3 border border-2 prompt-section rounded-4 border-secondary">
                        <div>
                            <textarea oninput="autoResize(this)" disabled name="prompt" rows="3"
                                    ...
                                    <div class="p-3 border rounded shadow-sm">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="pb-3 col-12">
                                                <span class="text-muted fw-bold">{{ $lables[strtolower($type) .
                                                    '_metrics'] }}
                                                </span>
                                            </div>
                                            @endif
