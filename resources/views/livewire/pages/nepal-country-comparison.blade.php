<div>
                    ...
                    <section class="first-prompt">
                        ...
                        <div class="mb-3 text-center firstPrompt">
                            ...
                            <h2 class="flex justify-center items-center"><img class="mx-2"
                                    ...
                                    alt="">India-Nepal Comparison <img class="mx-2"
                                    src="https://g2c.prarang.in/storage/images/world/195Counties/NPL__flag.jpg" alt="">
                            </h2>
                            <p>Compare Nepal Regions (Districts) with Indian Regions (Districts)</p>
                        ...
                        <div class="col-sm-12">
                            ...
                            <h2>
                                ...
                                <img class="mx-2 cze-mapx " style="width: 50px; height: 50px;"
                                    src="{{ asset('images/nepal_flag.jpg') }}" alt="">Country Comparison
                            </h2>
                            @endif
                            </p>
            ...
            <div class="@if ($output) d-none @else col-lg-3 d-none @endif">
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="https://g2c.prarang.in/nepal" class="list-group-item list-group-item-action"
                            target="_blank">
                            Nepal AI Report
                        </a>
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="geographyModalLabel"><small>
                                ...
                                <p class="mb-2 ">Choose up to {{ $maxCzeRegions ?? 3 }} Czech regions (kraje)
                                    ...
                                    regions.</p>
                                @else
                                <p class="mb-2 text-info">Select up to 5.</p>
                                @endif
                            </small></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 col-md-4 mb-2">
                                                        ...
                                                        <input class="form-check-input me-1" type="checkbox"
                                                            ...
                                                            @if ($country['Country']==$country1 ||
                                                            $country['Country']==$country2 ) checked disabled @endif
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateCountAndToggle() {
            // Find and ensure Nepal is always selected
            const checkboxes = Array.from(document.querySelectorAll('#accordionCitiesCountries input[type="checkbox"]'));
            const nepalCheckbox = checkboxes.find(cb => cb.nextElementSibling?.textContent?.includes('Nepal'));
            if (nepalCheckbox && nepalCheckbox.checked === false) {
                nepalCheckbox.checked = true;
            }

            const checkedBoxes = Array.from(checkboxes).filter(cb => cb.checked);
            const checkedCount = checkedBoxes.length - 0; // Exclude Nepal
            if (countDisplay) {
