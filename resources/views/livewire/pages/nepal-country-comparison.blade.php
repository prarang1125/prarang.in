<div>
        ...
        <div class="row locale-font">
            <div class="{{ $output ? 'col-12' : '' }} position-relative">
                <div class="pr-ai-section">
                                ...
                                <div class="col-12">
                                    <div class="mb-3 firstPrompt">
                                        <div class="main-button-area">
                                            ...
                                            <div class="arrow">
                                                <div><p><i class='bx bx-down-arrow-alt'></i></p></div>
                                                <div></div>
                                            </div>
                    ...
                    @if ($output)
                    @php
                        $backUrl = '/nepal-country-comparison';
                                    ...
                                    <section class="sourcedat">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                <span class="text-small">[{{ $key }}] {{ $ss['local_source'] ?? $ss['source'] }}</span>
                                        ...
                                        <ul class="row">
                                            ...
                                            <li class="col-12 col-md-3">
                                                <a target="_blank" style="text-decoration:none;"
                                                    ...
                                                    {{ json_decode($geography)->name }} {{ $lables['insights'] }}
                                                </a>
                                            </li>
                                            @endforeach
                                        </ul>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="categoryModalLabel">
                        <small><p class="mb-2 text-info">{{ $lables['metrics_select_message'] }}</p></small>
                    </h5>
                            ...
                            <ul class="nav nav-pills flex-column" id="categoryTabs" role="tablist">
                                ...
                                <li class="mb-1 nav-item" role="presentation">
                                    <button class="nav-link w-100 text-start @if ($loop->first) active @endif"
                                        ...
                                        data-bs-target="#content-{{ $main }}" type="button" role="tab"
                                        aria-controls="content-{{ $main }}"
    ...
    {{-- ── Geography Modal ── --}}
    <div class="modal fade" id="geographyModal" tabindex="-1"
        aria-labelledby="geographyModalLabel" aria-hidden="true" wire:ignore.self>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="geographyModalLabel">
                        <small><p class="mb-2 text-info">Select up to 5 countries.</p></small>
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                    ...
                    <div class="accordion" id="faqAccordion">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faqCollapseAI" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body">
                                    <p class="mb-2">Information is not Knowledge. Knowledge is not Intelligence. Intelligence is not Wisdom.</p>
                                    <p class="mb-2">
    ...
    <script>
        ...
        function setContents() {
            ...
            if (!input) { alert('Error setting content!'); return false; }
