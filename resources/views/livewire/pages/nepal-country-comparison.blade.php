                            ...
                            <div class="mb-3 text-center firstPrompt">
                                ...
                                @if ($type === 'regional')
                                    <h2 class="flex justify-center items-center"><img class="mx-2"
                                            ...
                                            src="https://g2c.prarang.in/storage/images/world/195Counties/NPL__flag.jpg"
                                            alt="">
                                    </h2>
                ...
                @else
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <a href="https://g2c.prarang.in/nepal"
                                class="list-group-item list-group-item-action" target="_blank">
                                Nepal AI Report
                            </a>
                ...
                <h5 class="modal-title" id="geographyModalLabel"><small>
                        ...
                        @if ($type === 'regional')
                            <p class="mb-2 ">Choose up to {{ $maxCzeRegions ?? 3 }} Czech regions (kraje)
                                ...
                                regions.</p>
                        @else
                            <p class="mb-2 text-info">Select up to 3 countries to compare with Nepal.</p>
                        @endif
                    </small></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                                                    ...
                                                    @foreach ($countries as $country)
                                                        <div class="col-6 col-md-4 mb-2">
                                                            ...
                                                            <input class="form-check-input me-1" type="checkbox"
                                                                ...
                                                                @if ($country['Country'] == 'Nepal') checked disabled @endif
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateCountAndToggle() {
            ...
            const checkedCount = checkedBoxes.length - 1; // Exclude Nepal
            if (countDisplay) {
