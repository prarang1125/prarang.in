                ...
                <div class="rounded-2xl border border-blue-200 bg-gradient-to-b from-blue-50/30 to-blue-50/60 p-4 shadow-sm relative z-30"
                    ...
                    <div class="flex items-center justify-between gap-3">
                        <div
                            ...
                            <span>Cities {{ count($selectedTownIds) > 0 ? '# ' . count($selectedTownIds) : '' }}</span>
                            <div wire:loading wire:target="townState, townDistrict, townCityType"
                                class="spinner-border spinner-border-sm text-blue-600" role="status"
                                aria-hidden="true">
                            </div>
                        </div>
                        ...
                        <div x-cloak x-show="open" @click.away="open = false"
                            ...
                            <div class="mt-3 max-h-56 space-y-1.5 overflow-y-auto pr-1">
                                ...
                                <div
                                    ...
                                    <svg class="w-6 h-6 mx-auto mb-2 text-slate-300" fill="none"
                    ...
                    <div class="mt-3 flex flex-wrap gap-1.5 max-h-24 overflow-y-auto">
                        ...
                        <span
                            ...
                            {{ $selectedTown['name'] }}
                            <button type="button"
                                wire:click="removeTownSelection('{{ $selectedTown['id'] }}')"
                ...
                <div
                    ...
                    <div
                        ...
                        <div wire:loading wire:target="villageState"
                            class="spinner-border spinner-border-sm text-emerald-500" role="status"
                            aria-hidden="true">
                        </div>
                    </div>
                    <select wire:model.live="villageDistrict" @disabled(!$villageState)
                        wire:loading.attr="disabled" wire:target="villageState, villageDistrict"
                ...
                <div class="rounded-2xl border border-emerald-200 bg-gradient-to-b from-emerald-50/30 to-emerald-50/60 p-4 shadow-sm relative z-20"
                    ...
                    <div class="flex items-center justify-between gap-3">
                        <div
                            ...
                            <span>Villages
                                {{ count($selectedVillageIds) > 0 ? '# ' . count($selectedVillageIds) : '' }}</span>
                        ...
                        <div x-cloak x-show="open" @click.away="open = false"
                            ...
                            <div class="mt-3 max-h-56 space-y-1.5 overflow-y-auto pr-1">
                                ...
                                <button type="button" wire:key="village-btn-{{ $villageItem['id'] }}"
                                    ...
                                    @click.prevent="$wire.toggleVillageSelection('{{ $villageItem['id'] }}')"
                                    :class="isSelected('{{ $villageItem['id'] }}') ?
                                    ...
                                    <div :class="isSelected('{{ $villageItem['id'] }}') ?
                                        ...
                                        <svg x-show="isSelected('{{ $villageItem['id'] }}')" class="w-3 h-3"
                                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex flex-col gap-2">
                ...
                <div
                    ...
                    <div class="mt-1 text-base font-bold text-slate-800">
                        ...
                        {{ count($selectedTownIds) + count($selectedVillageIds) }}
                        {{ Str::plural('Geography', count($selectedTownIds) + count($selectedVillageIds)) }}
                        Selected
                        @endif
                    </div>
                </div>
                    ...
                    <div class="mb-4 last:mb-0">
                        ...
                        <div class="grid grid-cols-3 gap-1">
                            ...
                            <span
                                ...
                                <span class="truncate"
                                    title="{{ $town['name'] }}">{{ $town['name'] }}</span>
                                <button type="button"
                                    wire:click="removeTownSelection('{{ $town['id'] }}')"
                    ...
                    <div class="mb-4 last:mb-0">
                        ...
                        <div class="grid grid-cols-3 gap-1">
                            ...
                            <span
                                ...
                                <span class="truncate"
                                    title="{{ $village['name'] }}">{{ $village['name'] }}</span>
                                <button type="button"
                                    wire:click="removeVillageSelection('{{ $village['id'] }}')"
