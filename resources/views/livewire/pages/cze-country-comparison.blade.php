<div>
    ...
    <style>
        ...
        .space-y-4 .items-center .items-center {
            ...
            grid-template-columns: 10% 15% 50% 18.67%;
        }

        /* Items center */
        .container div #toprint .row .col-sm-4 .id-selector form div .space-y-4 .items-center .items-center {
            grid-template-rows: auto !important;
            grid-template-columns: 10% 15% 50% 18.67% !important;
        }
    </style>
    ...
    <div class="container-fluid" id="toprint">
        ...
        <div class="row locale-font">
            <div class="@if ($output) col-8 @else  - @endif position-relative">
                <div class="pr-ai-section">
                    <section class="first-prompt">
                        ...
                        <div class="mb-3 text-center firstPrompt">
                            ...
                            <p>Compare Czech Republic Regions (Kraje) with Indian Regions (Districts)</p>
                                            ...
                                            <div class="select-location">
                                                ...
                                                <div>
                                                    <span class="p-2 m-2 border count-box bg-light text-dark"
                                                        id="citiesCount" @if ($type==='regional' ) wire:ignore.self
                                            ...
                                            <div class="select-prompt">
                                                <div>
                                                    <div class="text-center">
                                                        <a class="btn btn-primary" wire:click="generate" role="button"
                                                            tabindex="0" wire:loading.attr="disabled"
            ...
            <div class="@if ($output) col-sm-4  @else col-lg-3 d-none @endif">
                        ...
                        <div>
                            <div class="space-y-4">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <label class="flex items-center space-x-2">
                                        <input type="checkbox" name="model[]" value="perplexity" data-ai="perplexity">
                                    ...
                                    <!-- Gemini Option -->
                                    <label class="flex items-center space-x-2">
                                        <input type="checkbox" name="model[]" value="gemini" data-ai="gemini">
                                    ...
                                    <!-- deepseek Option -->
                                    <label class="flex items-center space-x-2">
                                        <input type="checkbox" name="model[]" value="deepseek" data-ai="deepseek">
                                        <img src="https://chat.deepseek.com/favicon.svg" alt="" class="w-6 h-6">
                                        <span>
                                            <span>Deepseek</span>
                                    ...
                                    <!-- ChatGPT Option -->
                                    <label class="flex items-center space-x-2">
                                        <input type="checkbox" name="model[]" value="chatgpt" data-ai="chatgpt">
                                    ...
                                    <label class="flex items-center space-x-2">
                                        ...
                                        <img src="{{ asset('assets/ai/images/byr-btn.png') }}" alt="Upmana Logo"
                                            class="w-6 h-6">
                                        <span>
                                            <span>Upmana</span>
                                            <span>Prarang</span>
                                    ...
                                    <!-- Claude Option -->
                                    <label class="flex items-center space-x-2">
                                        <input type="checkbox" name="model[]" value="claude" data-ai="claude">
                                        <img src="https://claude.ai/images/claude_app_icon.png" alt="" class="w-6 h-6">
                                        <span>
                                            <span>Claude</span>
                                            <span>Anthropic</span>
                                        </span>
                                ...
                                <button class="btn btn-success" type="submit" onclick="return setContents()">
                                    {{ $lables['compare'] }}
                                </button>
                            </div>
                    </form>
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="list-group list-group-flush">
                        <a javascript:void(0) class="list-group-item list-group-item-action" data-bs-toggle="modal"
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="https://g2c.prarang.in/czech-republic" class="list-group-item list-group-item-action"
                            target="_blank">
                            Czech Republic AI Report
                        </a>
                                ...
                                <div class="mb-2 col-12 col-sm-4 col-lg-3">
                                    <div class="form-check">
                                        <input wire:loading.attr="disabled"
                                            wire:model="subChecks.{{ $sub['type'] }}.{{ $sub['id'] }}" type="checkbox"
                                            class="form-check-input" id="sub-{{ $sub['type'] }}-{{ $sub['id'] }}"
                                            value="{{ $sub['id'] }}">
                        ...
                        <div class="mb-3 col-4 col-md-2" id="categoryTabsContainer">
                            <ul class="nav nav-pills flex-column" id="categoryTabs" role="tablist">
                                ...
                                <li class="mb-1 nav-item" role="presentation">
                                    <button class="nav-link w-100 text-start @if ($loop->first) active @endif"
                                        id="tab-{{ $main }}" data-bs-toggle="tab" data-bs-target="#content-{{ $main }}"
                                        type="button" role="tab" aria-controls="content-{{ $main }}"
                        ...
                        <div class="col-8 col-md-10">
                            <div class="tab-content" id="categoryTabsContent">
                                ...
                                <div class="tab-pane fade @if ($loop->first) show active @endif"
                                    id="content-{{ $main }}" role="tabpanel" aria-labelledby="tab-{{ $main }}">
                                            ...
                                            <div class="mb-2 col-12 col-sm-4 col-lg-4">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label small"
                                                        for="sub-{{ $sub['type'] }}-{{ $sub['id'] }}">
                                                        {{ $sub['local'] }}
                                                        <span class="text-primary">{{ $sub['geo_type'] == 'in_dist' ?
                                                            'District' : '' }}</span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="list-group" style="max-height: 450px; overflow-y: auto;">
                                        ...
                                        <label
                                            ...
                                            <input class="form-check-input flex-shrink-0 m-0" type="checkbox"
                                                value="{{ $regionName }}" @change="toggleCze('{{ $regionName }}')"
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <label class="d-flex align-items-center gap-2 p-2 rounded"
                                                                ...
                                                                <input class="form-check-input m-0 flex-shrink-0"
                                                                    type="checkbox" value="{{ $cityData['city'] }}"
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="heading-{{ $continentId }}">
                                            <button class="accordion-button collapsed" type="button"
                                                data-bs-toggle="collapse" data-bs-target="#collapse-{{ $continentId }}"
                                                aria-expanded="false" aria-controls="collapse-{{ $continentId }}">
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="d-flex align-items-center justify-content-between w-100">
                            <div class="text-muted small">
                                Selected:
                                <strong x-text="selectedCze.length + selectedIndia.length">{{ $this->selectedCount
                                    }}</strong>
                            </div>
                        ...
                        <button type="button" class="btn btn-primary" onclick="geoSelect()">{{ $lables['done']
                            }}</button>
                        @endif
                    </div>
                </div>
                                ...
                                <div id="faqCollapseOnea" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <p>
                                            ...
                                            Models), is a method to reformat and restructure information using a layer
                                            of
                                ...
                                <div id="faqCollapseOnea" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <p>
                                            ...
                                            <span class="fw-bold">Information </span> structured & organized data &
                                            facts,
                                            which
                                            are useful.
                                            Understanding information and related concepts creates <span
