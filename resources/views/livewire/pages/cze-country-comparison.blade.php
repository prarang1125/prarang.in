            ...
            <div class="@if ($output) col-12 @else  col-lg-9 col-md-9 col-sm-12 @endif position-relative">
                <div class="pr-ai-section">
                                                ...
                                                <div>
                                                    <div class="text-center">
                                                        <a class="btn btn-primary" wire:click="generate" role="button"
                                                            tabindex="0" wire:loading.attr="disabled"><span
                                                                class="spinner-border spinner-border-sm" wire:loading>
                                                            </span>&nbsp;
                                                            Compare
                                                        </a>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <a href="/czech-republic-{{ $type }}-comparison" class="btn btn-dark btn-sm">
                            <i class="bx bi-arrow-left"></i> Back
                        </a> <button type="button" class="btn btn-warning btn-sm ms-5 " onclick="window.print()"
                            title="Print Page">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 border-end">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <span class="badge" :class="count($selectedCzeRegions) >=
                            ...
                            <div class="list-group" style="max-height: 450px; overflow-y: auto;" wire:ignore.self>
                                ...
                                @endphp
                                <label class="list-group-item d-flex font-bold align-items-center gap-3 border-0 py-2"
                                    style="cursor: pointer; transition: background-color 0.2s;"
                                    onmouseover="this.style.backgroundColor='#f8f9fa'"
                                    onmouseout="this.style.backgroundColor='transparent'">
                                    <input class="form-check-input flex-shrink-0 m-0" type="checkbox" wire:ignore.self
                                        name="czechRegion[]" value="{{ $regionName }}"
                                        wire:click="toggleCzeRegion('{{ $regionName }}')" @checked($isSelectedCze)
                                        @disabled(count($selectedCzeRegions)>= ($maxCzeRegions ?? 3) &&
                                    !$isSelectedCze)>
                        ...
                        <div class="col-md-7">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <span class="badge" :class="count($selectedIndiaCities) >=
                            ...
                            <div class="accordion" id="indianStatesAccordion "
                                ...
                                <div class="accordion-item" wire:ignore.self>
                                    <h2 class="accordion-header" id="heading{{ str_replace(' ', '', $stateName) }}">
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <label class="d-flex align-items-center gap-2 p-2 rounded"
                                                        ...
                                                        <input class="form-check-input m-0 flex-shrink-0"
                                                            ...
                                                            @checked($isSelected)
                                                            @disabled(count($selectedIndiaCities)>= $maxIndiaCities &&
                                                        !$isSelected)>
                                                        <span class="form-check-label">{{ $cityData['city'] }}</span>
                                                    </label>
                                                </div>
                                                @endforeach
                                            </div>
