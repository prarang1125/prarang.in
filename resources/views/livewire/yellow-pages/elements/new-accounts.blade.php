    ...
    <div class="registration-container">
        ...
        <div class="success-screen text-center animate__animated animate__fadeIn">
            ...
            <div class="share-url-box p-3 mb-4 rounded-4 border-2 border-dashed"
                ...
                <a href="{{ $shareUrl }}" class="fw-bold text-decoration-none" style="color: #e67e22;">{{ $shareUrl
                    }}</a>
            </div>
        ...
        <form wire:submit.prevent="register" class="registration-form">
            ...
            <p class="text-muted mb-4 small">{{ __('yp.welcome_back') ?? 'Create your professional presence online' }}
            </p>
            ...
            <!-- Submit Button -->
            <button type="submit" class="btn btn-primary w-100 py-3 mt-2 btn-register" wire:loading.attr="disabled">
                <span wire:loading.remove>
                    {{ __('yp.register') }} <i class="fas fa-arrow-right ms-2 small"></i>
                </span>
                <span wire:loading>
                    <span class="spinner-border spinner-border-sm me-2"></span> {{ __('yp.loading') ?? 'Processing...'
                    }}
                </span>
            </button>
