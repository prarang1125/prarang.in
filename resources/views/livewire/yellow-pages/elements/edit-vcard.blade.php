                    ...
                    <form wire:submit.prevent="submit">
                        <div class="vcard-header mb-4" style="background-color: {{ $color_code }}">
                            <div class="position-absolute top-0 start-0 m-3 text-start">
                                <label for="color_value"
                                    class="form-label small fw-bold mb-1">{{ __('formyp.select_color') }} *</label>
                            ...
                            @error('photo')
                                <div class="text-danger mt-2 small bg-white d-inline-block px-2 rounded">{{ $message }}
                                </div>
                            @enderror
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6 text-start">
                                ...
                                <input type="text" class="form-control"
                                    placeholder="{{ __('formyp.enter_house_no') }}" wire:model.blur="house_number">
                                @error('house_number')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 text-start">
                                ...
                                <input type="text" class="form-control"
                                    placeholder="{{ __('formyp.your_city') }}" wire:model.blur="cityname">
                                @error('cityname')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-6 text-start">
                                ...
                                <input type="text" class="form-control" wire:model.live="state"
                                    placeholder="{{ __('formyp.state_province') }}">
                                @error('state')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6 text-start">
                                ...
                                <input type="text" class="form-control"
                                    placeholder="{{ __('formyp.enter_phone') }}" wire:model.blur="phone">
                                @error('phone')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-6 text-start">
                                ...
                                <input type="email" class="form-control"
                                    placeholder="{{ __('formyp.email_label') }}" wire:model.blur="email">
                                @error('email')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                                ...
                                <div class="mb-3 d-flex align-items-end gap-2">
                                    <div class="flex-grow-1 text-start">
                                        ...
                                        <input type="{{ $field['type'] ?? 'text' }}" id="field_{{ $index }}"
                                            placeholder="{{ __('formyp.enter') }} {{ $field['name'] }}"
                                            class="form-control"
                                            wire:model.blur="dynamicFields.{{ $index }}.value">
                                    </div>
                                    <div class="pb-2">
                                        <span class="trash-btn text-muted"
                                            wire:click="removeField({{ $index }})" title="Remove">
