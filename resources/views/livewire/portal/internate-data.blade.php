                        ...
                        @if (isset($internateData[$key]))
                            <div class="p-1 flex justify-between items-center">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span
                                        class="text-base font-semibold text-gray-800 flex items-center gap-2 relative group">
                                        {{ $category['label'] }}
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <span
                                                    class="block text-sky-400 font-bold mb-1 border-b border-white/10 pb-1">{{ $category['label'] }}</span>
