...
$query = "SELECT chitti.chittiId AS post_id, img.imageUrl AS main_image_url, tagm.tagId AS tag_id, colorinfo.id AS emotion_id, colorinfo.name AS emotion, colorinfo.colorname AS emotion_color, facity.value AS for_about_city, chitti.totalViewerCount AS reach, chitti.fb_link_click, chitti.dateOfApprove AS post_date
FROM chitti
