...
{ 
   $sqlGeographyList=mysqli_query($dbconnect, "select replace(geographyCode,'r','') as areaId from msubscriberlist inner join msubscribergeography on msubscriberlist.subscriberId = msubscribergeography.subscriberId where msubscribergeography.geographyCode like 'r%' and msubscribergeography.subscriberId ='$subcriberId' ");
		...
		{			
			...
			{		
				...
				$areaId = $sqlChittiGeography['areaId'];
					...
					$regionCode = $sqlQueryArea['regionCode'];
				
				$chitti["chittiId"] = $obj["chittiId"];
				$chitti["postType"] =  $regionCode;
