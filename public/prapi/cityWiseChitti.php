...
{ 
   $sqlGeographyList=mysqli_query($dbconnect, "select replace(geographyCode,'c','') as areaId from msubscriberlist inner join msubscribergeography on msubscriberlist.subscriberId = msubscribergeography.subscriberId where msubscribergeography.geographyCode like 'c%' and msubscribergeography.geographyCode not like 'con%'  and msubscribergeography.subscriberId ='$subcriberId' ");
